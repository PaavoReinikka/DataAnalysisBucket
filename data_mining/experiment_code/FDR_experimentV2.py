...
def FDR_experimentV1_2(X,n_iter, alpha=0.05, equal_var=True, \
...
def FDR_experimentV2_2(X,n_iter, alpha=0.05, equal_var=True, \
                    mask_model = lambda x: np.zeros((x.shape[0],4)), effect_model=lambda x,y: x,\
...
def FDR_experimentV3_2(X,n_iter, alpha=0.05, equal_var=True, \
                    mask_model = lambda x: np.zeros((x.shape[0],4)), effect_model=lambda x,y: x,\
...
def FDR_resampling_experimentV1_2(X,n_iter, n_iter_inner=1000, alpha=0.05, equal_var=True,\
